...
static final _indigoNightTheme = ThemeData(
  ...
  highlightColor: const Color(0xFF5C58A7), // Another indigo variant for highlights
...
static final classicLightTheme = ThemeData(
  ...
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: Color(0xFFFE2C55)),
...
static final oceanBlueTheme = ThemeData(
  ...
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: Color(0xFF0288D1)),
...
static final darkForestTheme = ThemeData(
  ...
  scaffoldBackgroundColor: const Color(0xFF0B1F16), // Very dark, greenish black
  ...
  textTheme: const TextTheme(
    displayLarge: TextStyle(color: Color(0xFFD0D0D0), fontSize: 32, fontWeight: FontWeight.bold),
    displayMedium: TextStyle(color: Color(0xFFD0D0D0), fontSize: 28, fontWeight: FontWeight.bold),
    bodyLarge: TextStyle(color: Color(0xFFD0D0D0), fontSize: 16),
    bodyMedium: TextStyle(color: Color(0xFFD0D0D0), fontSize: 14),
    titleLarge: TextStyle(color: Color(0xFFD0D0D0), fontSize: 20, fontWeight: FontWeight.bold),
    titleMedium: TextStyle(color: Color(0xFFD0D0D0), fontSize: 16, fontWeight: FontWeight.w500),
    labelLarge: TextStyle(color: Color(0xFFD0D0D0), fontSize: 14, fontWeight: FontWeight.w500),
  ),
  ...
  navigationBarTheme: NavigationBarThemeData(
    ...
    labelTextStyle: MaterialStateProperty.all(
      const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFFD0D0D0)),
    ),
  ),
  ...
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: Color(0xFF2E4E3F)),
...
static final pinkCutesyTheme = ThemeData(
  ...
  textTheme: const TextTheme(
    displayLarge: TextStyle(color: Color(0xFF1B1B1B), fontSize: 32, fontWeight: FontWeight.bold),
    displayMedium: TextStyle(color: Color(0xFF1B1B1B), fontSize: 28, fontWeight: FontWeight.bold),
    bodyLarge: TextStyle(color: Color(0xFF1B1B1B), fontSize: 16),
    bodyMedium: TextStyle(color: Color(0xFF1B1B1B), fontSize: 14),
    titleLarge: TextStyle(color: Color(0xFF1B1B1B), fontSize: 20, fontWeight: FontWeight.bold),
    titleMedium: TextStyle(color: Color(0xFF1B1B1B), fontSize: 16, fontWeight: FontWeight.w500),
    labelLarge: TextStyle(color: Color(0xFF1B1B1B), fontSize: 14, fontWeight: FontWeight.w500),
  ),
  ...
  navigationBarTheme: NavigationBarThemeData(
    ...
    labelTextStyle: MaterialStateProperty.all(
      const TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFF1B1B1B)),
    ),
  ),
  ...
  progressIndicatorTheme: const ProgressIndicatorThemeData(color: Color(0xFFFF8FAB)),
